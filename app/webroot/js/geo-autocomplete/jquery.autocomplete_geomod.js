...
$.Autocompleter = function(input, options) {
	...
	function selectCurrent() {
		...
		if (options.selectCurField) {
			var v = selected.data[options.selectCurField];
		} else {
	...
	function request(term, success, failure) {
		...
		// request handler for google geocoder
			...
			options.selectCurField = 'formatted_address';	//to get full address and not just the first line.
